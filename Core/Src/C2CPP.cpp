...
void C2CPPStartup(TIM_HandleTypeDef *htim2, TIM_HandleTypeDef *htim5, TIM_HandleTypeDef *htim3){
	...
	rpvMan = new RPVManager(RPV_TYPE_MULTI_ROTOR, outputChannels, inputChannels);
}
